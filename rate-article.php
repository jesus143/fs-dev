...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>		  
		...
		<!-- new look -->
            ...
            <script type="text/javascript" src='fs_folders/js/rate_article.js'></script>
		<!-- end look  -->
					 					...
					 					<table id='clock' border="0"  style="<?php echo "$clock_style"; ?>"  >   
					 						...
					 						<tr>  
					 							<td id='clock_drop_td' style="display:none" >
					 								...
					 								<div id='bmcc' > 
						 								<center>
						 									<!-- <img id='arrow_upb1' src="fs_folders/index_h	ome/home_img/arrow_up.png">	 -->
						 								</center>
							...
							<tr>
							  	<td id="article-page-featured-image-td"> 
							      	<div> 
							        	...
							        	<img src="fs_folders/images/article/article-featured-image.png"> 
							      	</div>   
							  	</td>  
							</tr>
                            <td>
                                <div id="rate-look-dropdown" >
                                    <center>
                                        <table border="0" cellpadding="0" cellspacing="0" >
                                            <tr>
                                                <td>
                                                    <input id="rate-table-name" type="text" value="fs_postedarticles"  class="hide" />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <select  id="rate-look-topic" onchange="rate_look_retrieve_nextprev_and_look_modals( )" >
                                                    	<option  >Select Topic</option>
                                                    </select>
                                                </td>  
                                                <td>
                                                    <select id="rate-look-latest" onchange="rate_look_retrieve_nextprev_and_look_modals( )"  >
                                                        <option title="Show the total looks that has been uploaded that month" value="Latest Articles" >
                                                            Latest Articles
                                                        </option>
                                                        <option title="Show the looks with the highest rating" value="Most Likes" >
                                                            Most Likes
                                                        </option>
                                                    </select>
                                                </td>
