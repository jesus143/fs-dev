...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head> 
		<?php  
         ...
         if ($_GET['welcome'] == 'get-started' || $mc->tlog >= 4) {
							...
							<table id="profile-body-content" border="0" cellpadding="0" cellspacing="0" >
								...
								<tr>  
									<td id="profile-body-content-header" >   
										<table id="look_header_t" border="0" cellpadding="0" cellspacing="0"   class="hide"  > 
											<tr>  
								...
								<tr>  
									<td>    
										...
										<center> 
											<div   style="display:none;background-image: url('<?php echo "$mc->profileTimeline_cropped/$mptno"; ?>')" id='profile-timeline' class="profile-timeline-view-popup" > 
												<?php require( "fs_folders/profile/page/profile_timeline_view_popup.php" );  ?>
											</div>

											<div style="display:block; background-image: url('<?php echo "$mc->profileTimeline_cropped/$mptno"; ?>')" id='profile-timeline'  class="profile-timeline-view" >
								...
								<tr>
									<td id="profile-body-content-activities">   
										<table id="profile-body-content-activities-table" border="0" cellspacing="0" cellpadding="0" > 
												...
												<td id="profile-body-content-activities-table-menu" >   
													<div id="profile-main-menu-wrapper" >  
														...
														<table id="profile-body-content-activities-table-menu-table" border="0" cellpadding="0" cellspacing="0" width="auto" > 	
															<!-- <tr>  -->
																<!-- <td id="profile-body-content-activities-table-menu-history" style="padding-left:0px;"  > <span>  </span> </td> -->
															<tr>  
																<td 
																id="profile-body-content-activities-table-menu-activity"  class="profile-texttab"  
																onmouseover="profile_tab_hovered(this, 'profile-tab-underline-activity')"  
																onmouseout="profile_tab_out(this, 'profile-tab-underline-activity')"  
																onclick="profile_change_tab ( 'latest'    , '#profile-body-content-activities-table-menu-activity span'  , '#profile-tab-underline-activity div'  , 'profile-tab-loader-activity div img'     , '<?php echo $mno1; ?>' , 'profile-tabs' , event , 'no sub tab' 		    ,  'profile-tabs'  )" > <span> LATEST ACTIVITY <span style='font-size:12px' >(<?php echo number_format($total['activity']); ?>)</span></span> </td>  
																
																<td 
																	id="profile-body-content-activities-table-menu-blogs"     
																	class="profile-texttab"  
																	onmouseover="profile_tab_hovered(this, 'profile-tab-underline-blogs')"  
																	onmouseout="profile_tab_out(this, 'profile-tab-underline-blogs')"  
																	onclick="profile_change_tab ( 'blogs'     , '#profile-body-content-activities-table-menu-blogs span'     , '#profile-tab-underline-blogs div'     , 'profile-tab-loader-blogs div img'        , '<?php echo $mno1; ?>' , 'profile-tabs' , event , '#blog-sub-categories' ,  'profile-tabs' )" > <span> ARTICLES   <span style='font-size:12px' >(<?php echo number_format($total['articles']); ?>)</span></span> </td> 
																
																<td 
																	id="profile-body-content-activities-table-menu-looks"     
																	class="profile-texttab"  
																	onmouseover="profile_tab_hovered(this, 'profile-tab-underline-looks')"  
																	onmouseout="profile_tab_out(this, 'profile-tab-underline-looks')"  
																	onclick="profile_change_tab ( 'looks'     , '#profile-body-content-activities-table-menu-looks span'     , '#profile-tab-underline-looks div'     , 'profile-tab-loader-looks div img'        , '<?php echo $mno1; ?>' , 'profile-tabs' , event , '#look-sub-categories' ,  'profile-tabs' )" > <span> LOOKS      <span style='font-size:12px' >(<?php echo number_format($total['looks']); ?>)</span></span> </td> 
																
																<td 
																	id="profile-body-content-activities-table-menu-comments"  
																	class="profile-texttab"  
																	onmouseover="profile_tab_hovered(this, 'profile-tab-underline-comments')"  
																	onmouseout="profile_tab_out(this, 'profile-tab-underline-comments')"  
																	onclick="profile_change_tab ( 'comments'  , '#profile-body-content-activities-table-menu-comments span'  , '#profile-tab-underline-comments div'  , 'profile-tab-loader-comments div img'     , '<?php echo $mno1; ?>' , 'profile-tabs' , event , 'no sub tab' 			,  'profile-tabs' )" > <span> COMMENTS   <span style='font-size:12px' >(<?php echo number_format($total['comment']); ?>)</span></span> </td>   															
																
																<td 
																	id="profile-body-content-activities-table-menu-beloved"   
																	class="profile-texttab"  
																	onmouseover="profile_tab_hovered(this, 'profile-tab-underline-beloved')"  
																	onmouseout="profile_tab_out(this, 'profile-tab-underline-beloved')"  
																	onclick="profile_change_tab ( 'beloved'   , '#profile-body-content-activities-table-menu-beloved span'   , '#profile-tab-underline-beloved div'   , 'profile-tab-loader-beloved div img'      , '<?php echo $mno1; ?>' , 'profile-tabs' , event , 'no sub tab' 			,  'profile-tabs' )" > <span> FAVORITES   <span style='font-size:12px' >(<?php echo number_format($total['favorite']); ?>)</span></span> </td> 
																
																<td 
																	id="profile-body-content-activities-table-menu-followers" 
																	class="profile-texttab"  
																	onmouseover="profile_tab_hovered(this, 'profile-tab-underline-followers')"  
																	onmouseout="profile_tab_out(this, 'profile-tab-underline-followers')"  
																	onclick="profile_change_tab ( 'followers' , '#profile-body-content-activities-table-menu-followers span' , '#profile-tab-underline-followers div' , 'profile-tab-loader-followers div img'    , '<?php echo $mno1; ?>' , 'profile-tabs' , event , 'no sub tab' 			,  'profile-tabs' )" > <span> FOLLOWERS  <span style='font-size:12px' >(<?php echo number_format($total['followers']); ?>)</span></span> </td> 
																
																<td 
																	id="profile-body-content-activities-table-menu-following" 
																	onmouseover="profile_tab_hovered(this, 'profile-tab-underline-following')"  
																	onmouseout="profile_tab_out(this, 'profile-tab-underline-following')"  
																	class="profile-texttab"  
																	onclick="profile_change_tab ( 'following' , '#profile-body-content-activities-table-menu-following span' , '#profile-tab-underline-following div' , 'profile-tab-loader-following div img'    , '<?php echo $mno1; ?>' , 'profile-tabs' , event , 'no sub tab' 			,  'profile-tabs' )" > <span> FOLLOWING  <span style='font-size:12px' >(<?php echo number_format($total['following']); ?>)</span></span> </td>  
															<tr>  
													...
													<div id="profile-sub-menu-wrapper"  >     
						 								...
						 								<table  border="0" cellpadding="0" cellspacing="0" width="100%" >
															<tr> 
																<td id="profile-look-percentage-ratings" >    
											...
											<tr>
												<td id="profile-body-content-activities-table-nextprev-top" style="padding-top:20px;">    
												</td>
											<tr>
												<td> 
