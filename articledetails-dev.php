...
// $_SESSION['details_user_mno'] = $mno;
            ...
            #USER OWNER MODAL 
                ...
                $user1['user']                               = $mc->get_user_full_fs_info( $modal['mno'] );
                $user1['trating']                            = $user1['user']['otrating'];
                $user1['tfollower']                          = $user1['user']['tfollowers'];
                $user1['following']                          = $user1['user']['tfollowing'];
                $user1['tlooks']                              = $user1['user']['tlooks'];
                $user1['tpercentage']                        = $user1['user']['opercentage'];
                $user1['username']                           = $user1['user']['username'];
                $user1['tarticle']                           = $user1['user']['tarticle'];
                $user1['profile_tab']                        = 'articles';
                $user1['fullName']                           = $user1['user']['fullName'];
                $user1['trating_article']                    = $user1['user']['trating_article'];;
        ...
        ?>
                                ...
                                <td id="banner_view_and_look_view"  >
                                    <table id="banner_view_and_look_view_table_container" border="0"  cellpadding="0" cellspacing="0" >
                                        <tr>
                                            <td id='lbc_look_view' >
                                        <?php
                                        $user_total_followers    = $user1['tfollower'];
                                        $user_total_following    = $user1['following'] ;
                                        $user_total_percentage   = $user1['tpercentage'];
                                        $user_total_rating       = $user1['trating'];
                                        $user_total_lookuploaded = count($mc->retreive_specific_user_all_looks( $modal['mno']  ));
                                        $user_total_look_percentage  = $user1['tpercentage'];
                                    ...
                                    <tr>
                                        <td>
                                            <div class="center padding-profile-top padding-profile-bottom  paddin-profile-content" > 
                                                    <span class="black">
                                                        Article
                                                        <span class="bold"  > <bold> <a href="<?php echo $user1['username'] . '-articles'; ?>" ><?php echo number_format($user1['tarticle']); ?> </a> </bold> </span>
                                                        Likes
                                                        <span class="bold" > <bold>  <a href="#"> <?php echo number_format($user1['trating_article']); ?></a>   </bold> </span>
                                                        Followers
                                                        <span class="bold" > <bold> <a href="<?php echo $user1['username'] . '-followers'; ?>" id="details-follow-counter" >  <?php echo number_format($user1['tfollower']); ?> </a> </bold> </span>
                                                    </span>
                                            </div>
                                        </td>
                                    <tr>
                                        ...
                                        <tbody><tr>
                                            <td style="width:100px; text-align:center">
                                                <a href="#">
                                                  ...
                                                  // height: 62px; width: 63px;border-radius:3px;border:1px solid  #e2e2df; ; margin-top: 20px;border-radius: 5px;
                                                        // member_thumbnail_display( $path , $mno , $checkpath=null , $title=null , $width='50px' , $type=null, $height = '50px', $style='' )
                                                        $mc->member_thumbnail_display( $mc->ppic_thumbnail , $mc->mno , $mc->ppic_thumbnail,  $mc->get_full_name_by_id($mc->mno) , '60px', '', '60px',  'border:1px solid  #e2e2df; margin-top: 21px;border-radius: 4px;; margin-left: 14px;' );     
                                            ...
                                            <td style="padding-top:10px;padding-bottom:10px; padding-right: 20px; padding-bottom: 15px; ">
                                                <table border="0" style="width:200px; float:right;">
                                                    <tbody><tr>
                                                        ...
                                                        <td class="social-right" style="padding-left:39px"> 
            ...
            <div class="bg-white width-auto" >
                                                    ...
                                                    <table  border="0" cellspacing="0" cellpadding="0" class='margin-auto' >
                                                        ...
                                                        <tr>
                                                            <td id ="more-by-link-header" >
                                                                ...
                                                                <span id='recomended_name_t' > <a href="<?php echo $user1['username']; ?>" target='_parent' class="blue" > <?php echo $modal['modalownername'];; ?> </a>   </span> <span id='recomended_bar_t' >|</span>
                                                                <span> <?php echo "$modal[position] of $modal[total] "; ?>  </span> 
                                                                <span id='recomended_all_t' style='padding-left:5px;' title='all article' > <a href="<?php echo "$user1[username]-$user1[profile_tab]"; ?>"  class="blue" target='_parent' > All Article >> </a>  </span></span>
                                                            </td>
                                                    </table>
                                                </td>
                                            <tr>
                ...
                <div class="black bold  padding-bottom-comment center" id="more-category">
                    <span> More <?php echo $modal['category']; ?> Article </span>
                </div>
