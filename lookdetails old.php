...
<html>
	<head>
		...
		<!-- new comment -->
			...
			<script type="text/javascript" src='fs_folders/fs_lookdetails/look_comment_items/js/init.js' ></script>
			<script type="text/javascript" src='fs_folders/fs_lookdetails/look_comment_items/js/query.js' ></script>
		<!-- end comment -->
		...
		<!-- new header  -->
			...
			<link rel="stylesheet" type="text/css" href="fs_folders/page_footer/css/footer.css"> 
		<!-- end header  -->
	</head>
	<body onload='live_ajax_load()'  >
		<?php include_once("fs_folders/google_analytics/analyticstracking.php") ?>	
	
		<div id='res' style="position:fixed; margin-left:790px; margin-top:460px; font-size:11px;  font-wieght:bold; height:50px; width:200px; background-color:#000; color:white"> 
			res 
		</div>
 		...
 		<div id='lookdetails_wrapper' > 
	 		...
	 		<div id='lookdetails_body_container'> 
				<table id='lbc_main_table' border="0" > 
					<tr>  	
						<td id='lbc_ads_banner' > 	
							<table border="0" cellpadding="0" cellspacing="0"> 	
								...
								<tr> 
									<td> 
										<img src="fs_folders/images/header/banner.jpg" title="big banner">
									</td>
								<tr> 
									<td id='next_prev_td'> 
										<span id='return_to_feed' title='return to feed' onclick='Go("index.php")' > < < RETURN TO FEED </span>
										<span id='next_prev' > 
						...
						<td id='lbc_look_view' > 
									...
									<td id='look_view_img_td'>  
										<center> 
											<?php 
												if ( empty($con->plook) ) 
												{
												 	echo "<img id='look_view_img' src='fs_folders/images/posted look/3.jpg'>";
												}
												else 
												{ 
													echo "<img id='look_view_img' src='$con->plook' > ";
												}
											?> 
										</center>
									</td>
									 	...
									 	<div id='lf_div_container'> 
									 		<table id='lfdc_t1' border="0" cellpadding="0" cellspacing="0"> 
									 			<tr>  
									 				...
									 				<td id='ldmtd'>  
															<img id='ldmsc' src="fs_folders/images/attr/ld_message_c.png" title="message container" >  
									 					<img id='ldms' src="fs_folders/images/attr/ld_5stars.png" title="start">  
									 				</td>
									 				<td id='ld_eyes' >  
										 				<img src="fs_folders/images/attr/ld_eyes.png" title="eyes ni sya" >
										 				<span id='ttext' > 9999+ </span>
									 				</td>
									 				<td id='total_arrow' > 
									 					<img src="fs_folders/images/attr/total_arrow.png" title="square arrow">
									 					<span id='ttext' > 9999+</span>
									 				</td>
									 				<td id='total_heart' > 
														<img src="fs_folders/images/attr/total_heart.png" title="temp heart">
									 					<span id='ttext' > 9999+</span>
									 				</td>
									 				<td id='ld_star_with_cross'  > 
									 					<img src="fs_folders/images/attr/ld_star_with_cross.png" title="star with cross" >
									 				</td>
									 				<td id='ld_scope' >
									 					<img src="fs_folders/images/attr/ld_scope.png" title="scope" >
									 				</td>
									 				<td id='ld_negative'  > 
									 					<img src="fs_folders/images/attr/ld_negative.png"  title="circle with negative" >
									 				</td>
									 				<td id='ld_square_with_arrow'  > 
									 					<img src="fs_folders/images/attr/ld_square_with_arrow.png" title=" square with arrow" >
									 				</td>
									 				<td id='ld_pencil'  > 
									 					<img src="fs_folders/images/attr/ld_pencil.png"  title="pencil" >
									 				</td>
									 		</table>
									 	</div>
							...
							<div id='square_with_arrow_clicked_cotainer' > 
								...
								<div> 	
									<table border="0" cellpadding="0" cellspacing="0"  > 
										<tr>  
											<td><img src="fs_folders/images/attr/ld_white_fb.png"    title="facebook" ></td>
											<td><img src="fs_folders/images/attr/ld_white_tw.png"    title="twitter" ></td>
											<td><img src="fs_folders/images/attr/ld_white_t.png"     title="tumblr" ></td>
											<td><img src="fs_folders/images/attr/ld_white_q.png"     title="q" ></td>
											<td><img src="fs_folders/images/attr/ld_white_g+.png"    title="google" ></td>
											<td><img src="fs_folders/images/attr/ld_white_line.png"  title="line" ></td>
											<td><img src="fs_folders/images/attr/ld_white_mail.png"  title="mail" ></td>
									</table>
								</div>
							</div>
							<br>  
										...
										<div id='look_smallads_display' > 
											...
											<table id='recomended_lookt' border="0" cellpadding="0" cellspacing="0" > 
												...
												{ 
													...
													{?>
														<td> 
															<img id='landscape' src="fs_folders/images/posted look thumb nail/<?php echo $c; ?>.jpg">
														</td>
												<?php 
													}
													else 
													{?>
														<td> 
															<img id='portrate' src="fs_folders/images/posted look thumb nail/<?php echo $c; ?>.jpg">
														</td>
												<?php 
													}
													if ( $c%3==0) 
												...
												<td id='tag_pattern_td' > 
													<table cellspacing="0" cellpadding="0"> 
														<tr>  	
															...
															<td><img id='' src="fs_folders/images/attr/ld_tag_pattern.jpg" ></td>
													</table>	
												</td>
											<tr>  
												<td> 
								...
								<tr>  
									<td id='ld_big_ads'> 
										...
										<table border="0"> 
											<tr>  
												<td> 
													<img src="fs_folders/images/ads/1.jpg">
												</td>
												<td> 
							...
							<table id='look_comment_t1' border="0" cellpadding="0" cellspacing="0"> 
								...
								<tr>  
									<td id='comment_content'> 
									 <div id='comment_loader' ><img src="fs_folders/images/attr/loading 2.gif"> </div>
										
									 	<ul id='comment_ads_right' >  
									 		ads
										</ul>
									 	<?php 
									 		$tlc = $mc->get_total('plcno','posted_looks_comments','plno',$_SESSION['plno']);
									 		 
									 		$mc->next_prev_comments($tlc); 
									 	?>
										<ul id='comments_result' class='comments_result' >
										</ul>
										<?php $mc->next_prev_comments($tlc); ?>	

										<div  id='comment_post_loader' ><img src="fs_folders/images/attr/loading 2.gif" > </div>
										<?php require("fs_folders/fs_lookdetails/look_comment_items/comment_field.php"); ?>
					...
					<tr> 
						<td id='lbc_footer'> 
							<?php  require ("fs_folders/page_footer/footer.php") ?> 
						</td>
				</table>		 		 	
			</div>	
