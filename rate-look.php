...
// echo " <bR><br><bR><Br>mno ".$_SESSION['mno'];
	...
	$url['toplook']=(!empty($_GET['toplook']))?$_GET['toplook']:'alllooks';  
	...
	if ($url['category']=='alllooks'){
		...
		$select['value8']="selected='selected'";
		...
		$select['value9']="selected='selected'";
	...
	}elseif($url['category']=='formal'){
		$header['title']='Formal';
		$header['category']='casual fashion, casual  fashion bloggers, casual clothing, casual fashion accessories, casual fashion inspiration, casual ootd, casual fashion looks, celebrity casual fashion inspiration, casual fashion designers, casual style, casual shoes, casual pants, casual hats, casual shirts, casual skirts, casual dress, casual tops, casual accessories, casual jewelry, cheap casual clothing, cheap casual fashion, casual jeans, casual purses, casual fashion brands, causal fashion sites';
		$select['value5']="selected='selected'";
	} elseif($url['category']=='grunge'){
		$header['title']='Grunge';
		$header['category']='casual fashion, casual  fashion bloggers, casual clothing, casual fashion accessories, casual fashion inspiration, casual ootd, casual fashion looks, celebrity casual fashion inspiration, casual fashion designers, casual style, casual shoes, casual pants, casual hats, casual shirts, casual skirts, casual dress, casual tops, casual accessories, casual jewelry, cheap casual clothing, cheap casual fashion, casual jeans, casual purses, casual fashion brands, causal fashion sites';
	...
	if($url['toplook'] == 'alllooks'){
		$select['toplook1'] ="selected='selected'";
	} else { 
		$select['toplook2'] ="selected='selected'";
	}
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>		  
		...
		<!-- new look -->
			...
			<script type="text/javascript" src='fs_folders/js/function_js' ></script>
		...
		<script type="text/javascript"> 
			$(window).ready(function() {  
                ...
                rate_look_retrieve_nextprev_and_look_modals();
			});
		</script>
                                        ...
                                        <center>
                                            <table border="0" cellpadding="0" cellspacing="0" >
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="gender" id="rate-look-gender"  onchange="rate_look_retrieve_nextprev_and_look_modals( )" >
                                                            <option value="Male Plus Female" >Men + Women</option>
                                                            <option value="Male" >Men</option>
                                                            <option value="Female" >Women</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select name="plus_blogger" id="rate-look-plus-blogger" onchange="rate_look_retrieve_nextprev_and_look_modals( )" >
                                                            <option value="All Blogger" >All Bloggers</option>
                                                            <option value="Yes" >Plus Size</option>
                                                            <option value="No" >Not Plus Size</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select  id="rate-look-style" onchange="rate_look_retrieve_nextprev_and_look_modals( )" >
                                                            ...
                                                            <option <?php echo $select['value2']; ?>>Bohemian</option>
                                                            <option <?php echo $select['value3']; ?>>Casual</option>
                                                            <option <?php echo $select['value4']; ?>>Chic</option>
                                                            <option <?php echo $select['value5']; ?>>Formal</option>
                                                            <option <?php echo $select['value6']; ?>>Grunge</option>
                                                            <option <?php echo $select['value7']; ?>>Menswear</option>
                                                            <option <?php echo $select['value8']; ?>>Preppy</option>
                                                            <option <?php echo $select['value9']; ?>>Streetwear</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select id="rate-look-latest" onchange="rate_look_retrieve_nextprev_and_look_modals( )"  >
                                                            <option title="Show the total looks that has been uploaded that month" value="All Looks" <?php echo $select['toplook1']; ?>>
                                                                All Looks
                                                            </option>
                                                            <option title="Show the looks with the highest rating" value="Top Rated" <?php echo $select['toplook2']; ?>>
                                                                Top Rated
                                                            </option>
                                                        </select>
                                                    </td>
